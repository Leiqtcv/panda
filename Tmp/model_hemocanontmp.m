...
dataStruct.t		= t;
dataStruct.dur		= dur;
u					= [ones(round(dur*Fs),1); zeros(round(40*Fs),1)]; % one block
dataStruct.u		= u;

dataStruct.X		= X; % stimulus  block
dataStruct.Ntotal	= length(y);
dataStruct.m		= length(u);
