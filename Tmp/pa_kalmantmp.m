...
for t=1:500
	if t<200
   tru(end+1) = randn*5+12;
	else
   tru(end+1) = randn*5+0;
	end
   s(end).z = tru(end) + randn*20; % create a measurement
