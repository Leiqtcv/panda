function pa_ac_topdown_aic
% PA_AC_TOPDOWN_AIC
%
% Determine Aikake Information Criterion for the multiplicative and
% additive models
...
%% Initialization
cd('E:\DATA\Cortex\top-down paper data'); % Marc's data
...
for ii				 = 1:length(files)
	...
	[A500,A1000]     = pa_ac_actsep(spikeA);
...
function [A1,A2] = pa_ac_actsep(Spike)
% PA_AC_ACT_SEP
%
% Separate the two active conditions into two Spike-structures
Spike