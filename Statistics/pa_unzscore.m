function B = pa_unzscore(varargin)
% B = PA_UNZSCORE(ZETA0,ZETA,MUX,SDX,MUY,SDY)
%
% Undo Z-transformation, as done by ZSCORE, or PA_ZSCORE
%
% To un-zscore variables:
% B = pa_unzscore(z,m,s);
%	or
% B = pa_unzscore(zx,mx,sx,zy,my,sy);
%
% To undo z-transform for linear regresssion parameters:
% B = pa_unzscore(zeta0,zeta,mx,sx); % if only predictor x was z-transformed
%	or
% B = pa_unzscore(zeta0,zeta,mx,sx,my,sy);
%
...
% E-mail: marcvanwanrooij@neural-ccode.com
