...
if ~loadflag
	...
	for roiIdx = 1:nroi
		...
		sel		= ismember(x1,1:3) & ismember(x2,1:2);
...
% 		x1		= x1-1;
	...
	pa_datadir
	save prepostnhanalysis BF param samp
	
else
	load prepostnhanalysis
	load petancova
...
if sum(selbf)
	...
	xlswrite('tableprepostnh',a,1,'A2');
	xlswrite('tableprepostnh',s,1,'B2');
	p	= NaN(nroi,2);
	for ii = 1:nroi
	...
	p	= p(:,2)-p(:,1);
	xlswrite('tableprepostnh',round(p(selbf)*10)/10,1,'C2');
	xlswrite('tableprepostnh',round(1./[BF(selbf).q1]'),1,'D2');
end
xlswrite('tableprepostnh',{'Brain region'},1,'A1');
xlswrite('tableprepostnh',{'Side'},1,'B1');
xlswrite('tableprepostnh',{'Beta'},1,'C1');
xlswrite('tableprepostnh',{'BF_{10}'},1,'D1');
...
if sum(selbf)
	...
	xlswrite('tableprepostnh',a,1,'E2');
	xlswrite('tableprepostnh',s,1,'F2');
	p	= NaN(nroi,2);
	for ii = 1:nroi
	...
	p	= p(:,2)-p(:,1);
	xlswrite('tableprepostnh',round(p(selbf)*10)/10,1,'G2');
	xlswrite('tableprepostnh',round(1./[BF(selbf).q2]'),1,'H2');
end
xlswrite('tableprepostnh',{'Brain region'},1,'E1');
xlswrite('tableprepostnh',{'Side'},1,'F1');
xlswrite('tableprepostnh',{'Beta'},1,'G1');
xlswrite('tableprepostnh',{'BF_{10}'},1,'H1');
...
if sum(selbf)
	...
	xlswrite('tableprepostnh',a,1,'I2');
	xlswrite('tableprepostnh',s,1,'J2');
	p	= NaN(nroi,2);
	for ii = 1:nroi
		p(ii,1)		= param(ii).b1(1);
		p(ii,2)		= param(ii).b1(3);
	...
	p	= p(:,2)-p(:,1);
	xlswrite('tableprepostnh',round(p(selbf)*10)/10,1,'K2');
	xlswrite('tableprepostnh',round(1./[BF(selbf).q3]'),1,'L2');
end
xlswrite('tableprepostnh',{'Brain region'},1,'I1');
xlswrite('tableprepostnh',{'Side'},1,'J1');
xlswrite('tableprepostnh',{'Beta'},1,'K1');
xlswrite('tableprepostnh',{'BF_{10}'},1,'L1');
...
if sum(selbf)
	...
	xlswrite('tableprepostnh',a,1,'M2');
	xlswrite('tableprepostnh',s,1,'N2');
	p	= NaN(nroi,2);
	for ii = 1:nroi
	...
	p	= p(:,2)-p(:,1);
	xlswrite('tableprepostnh',round(p(selbf)*10)/10,1,'O2');
	xlswrite('tableprepostnh',round(1./[BF(selbf).q4]'),1,'P2');
end
xlswrite('tableprepostnh',{'Brain region'},1,'M1');
xlswrite('tableprepostnh',{'Side'},1,'N1');
xlswrite('tableprepostnh',{'Beta'},1,'O1');
xlswrite('tableprepostnh',{'BF_{10}'},1,'P1');
...
xlswrite('tableprepostnh',1./[BF.q5]',1,'K2');
...
xlswrite('tableprepostnh',p,1,'J2');
...
xlswrite('tableprepostnh',1./[BF.q6]',1,'M2');
p = NaN(nroi,1);
for roiIdx = 1:nroi
	param(roiIdx).b1b2
	a = param(roiIdx).b1b2(2,2);
...
xlswrite('tableprepostnh',p,1,'L2');
...
xlswrite('tableprepostnh',1./[BF.q7]',1,'O2');
p = NaN(nroi,1);
for roiIdx = 1:nroi
	param(roiIdx).b1b2
	a = param(roiIdx).b1b2(2,3);
...
xlswrite('tableprepostnh',p,1,'N2');
