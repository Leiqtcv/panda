function pet_multilogregress_figure5(checkConvergence)
...
for areaIndx = 1:nArea
	...
	plot(bSample(1:100:end,1),bSample(1:100:end,2),'o','MarkerFaceColor',[.4 .4 .4],'MarkerEdgeColor','k');
	hold on
	xlim([-2 2]);
	ylim([-2 2]);
	box off
