...
hp = errorbar(muf,mum,sdm,mrk,'MarkerFaceColor','w','LineWidth',2,'MarkerSize',5,'Color',col);
hold on
...
beta	= b.beta;
str2		= [txt ': R^2 = ' num2str(b.rsquare,2)   ', p = ' num2str(b.fstat.pval,2)];
...
h		= text(0,2+off,str2); set(h,'Color',col)
