...
% 4549835	NH	male				1-11-1985	193	95	27-1-2010	29-1-2010	25-1-2010				124	124	124		
sub = '4549835';
fnamec		= [];
fnamev		= [];
fnamev2		= ['gswro_s' sub '-d20100129-mPET.img'];
fnameav		= ['gswro_s' sub '-d20100125-mPET.img'];
fnamec2		= ['gswro_s' sub '-d20100127-mPET.img'];

% 7437191	NH	female				4-7-1984	163	61	23-9-2008	22-9-2008	XXX				125	136	130		

% sub = '7437191';
% fnamec		= [];
% fnamev		= [];
% fnamec2		= ['gswro_s' sub '-d20080923-mPET.img'];
% fnamev2		= ['gswro_s' sub '-d20080922-mPET.img'];
% fnameav		= [];




% 4433787	NH	female				22-3-1985	168	61	24-9-2008	22-9-2008	23-9-2008				126	119	124		
% 
sub = '4433787';
fnamec		= [];
fnamev		= [];
fnamec2		= ['gswro_s' sub '-d20080924-mPET.img'];
fnamev2		= ['gswro_s' sub '-d20080922-mPET.img'];
fnameav		= ['gswro_s' sub '-d20080923-mPET.img'];

% 135401	NH	male				25-5-1976	186	83	16-10-2008	23-10-2008	30-10-2008				138	131	128		
sub = '0135401';
fnamec		= [];
fnamev		= [];
fnamec2		= ['gswro_s' sub '-d20081016-mPET.img'];
fnamev2		= ['gswro_s' sub '-d20081023-mPET.img'];
fnameav		= ['gswro_s' sub '-d20081030-mPET.img'];
