function pa_pet_pre_analysis(subject,cond)
...
comp_flag	= false; % compare two conditions
...
%% Comparison
if comp_flag
	files = {[dname '\wdro_' sstr num2str(subject) '-c-' cond];...
		[dname '\wdro_' sstr num2str(subject) '-av-' cond]};
