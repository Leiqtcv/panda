function pet_modelall_lat_xxx_123
% ANOVATWOWAYJAGSSTZ
%
...
if ~loadflag
	...
	paramb1b2b3	= NaN(nroi,3,3,2); % stimulus x laterality
...
%%
if b1flag
	latbraingraph1(data,d.D1,d.comp1,d.BF1,d.xlbl1,img,bcright,uroi,nroi,crit,indx,nindx,col,100)
end
...
function latbraingraph1(data,b,comp,BF01,xlabel,img,braincontour,uroi,nroi,crit,indx,nindx,col,basefig)
BF		= 1./BF01;
ncomp	= size(comp,1);
for cIdx = 1:ncomp
	disp('Analyze');
