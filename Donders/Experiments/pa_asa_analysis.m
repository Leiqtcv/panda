function pa_asa_analysis(fname)

if nargin<1
	fname = 'Ripple_detectionMD-2012-10-26-50p';
	dname = 'E:\DATA\Studenten\Michiel\Ripple';
end
cd(dname);
...
a = a(2:end); % for now
% keyboard
D = [ a' [S.zeros]' [S.maskvelocity]' [S.maskdensity]' [S.maskmodulation]' [S.sgnvelocity]',...
	 [S.sgndensity]'  [S.sgnmodulation]'  [S.delay]'  [S.amplitude]'  [S.sgnduration]',...
	  [S.samplefreq]'  [S.trial]']
