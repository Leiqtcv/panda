...
void CBar::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_SPIN1, s_BarScale);
}


BEGIN_MESSAGE_MAP(CBar, CDialog)
	ON_NOTIFY(UDN_DELTAPOS, IDC_SPIN1, &CBar::OnDeltaposSpin1)
END_MESSAGE_MAP()
...
void CBar::OnDeltaposSpin1(NMHDR *pNMHDR, LRESULT *pResult)
{
