...
void CExperiment::CreateExperiment()
{
	...
	stims[0].level    =    0; // 1;		// low, not pressed
	stims[0].event    =    1;
	...
	stims[3].start[1] =	   0;
	stims[3].stop[0]  =    3;
	stims[3].stop[1]  =  100;		// set here target fixed time (static sound period)
	stims[3].pos[0]   =    3;
	stims[3].pos[1]   =    3;
	...
	stims[4].start[1] =	   0;
	stims[4].stop[0]  =    4;
	stims[4].stop[1]  =  100;		// set here target changed time (dynamic sound period)
	stims[4].pos[0]   =    3;
	stims[4].pos[1]   =    3;
	...
	stims[5].level    =    1; // 0;		// high, pressed
	stims[5].event    =    0;
	...
	stims[6].start[1] =    0;
	stims[6].stop[0]  =    4;
	stims[6].stop[1]  =  100;		// set here target changed time (dynamic sound period)
	stims[6].bitno    =    0;		
	stims[6].mode     =    0;		// flank
	stims[6].edge     =    0; // 1;		// falling
	...
	stims[9].stop[0]  =    5;
	stims[9].stop[1]  =   10;		// duration 100 (subtract delay)
	stims[9].bitno    =    1;
