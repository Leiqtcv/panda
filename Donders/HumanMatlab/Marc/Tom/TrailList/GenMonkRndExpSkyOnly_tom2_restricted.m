...
Restrict_Flag	=	1;	%-- 1: Head-fixed monkey can't see lower targets		--%
...
AddFigs_Flag	=	0;	%-- 1: Additional test figures							--%
...
Random		=	0;
OMrange		=	45;
MinStep		=	1;	%-- Minimal n o steps (1: single step)					--%
...
if( WriteMat_Flag )
	...
	if (save_flag==1) 		% Matlab
		FileName	=	['rand' num2str(Ntarget) 'TarsSkyRestrict' datestr(now,'yyyy-mm-dd')];
		disp(FileName)
		cd 'D:\Tom\MonkeyMatlab\MonkeyV1';
