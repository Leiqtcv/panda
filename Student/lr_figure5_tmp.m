...
cd('E:\DATA\Studenten\Guus');

load sample_data_results_full.mat

y1 = SAMPLE_DATA(21,1).y(1,:);
y2 = SAMPLE_DATA(21,2).y(1,:);
y3 = SAMPLE_DATA(21,3).y;
% whos
% 
% y = pooled_blocks.y;
subplot(2,4,5)
