...
%% Uncertainty
fprintf(fid,'\t%s\r\n','# Uncertain values'); % Missing values

for ii = 1:Nmet
	str = ['xMet' num2str(ii) '[i] ~ dnorm(yMet' num2str(ii) '[i],tauxMet' num2str(ii) ')']; % normally distributed around mean of all conditions
	fprintf(fid,'\t\t%s\r\n',str); % Missing values
end
